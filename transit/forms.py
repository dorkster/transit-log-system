...
class EditTripForm(forms.Form):
    ...
    phone_address = forms.CharField(label='Phone', required=False, widget=forms.TextInput(attrs=formWidgetAttrs.phone))
    phone_destination = forms.CharField(label='Phone', required=False, widget=forms.TextInput(attrs=formWidgetAttrs.phone))
